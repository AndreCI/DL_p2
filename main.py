...
optimizer = SGDOptimizer(model, opt['lr'], opt['momentum'])

point_number = opt['point_number']

train_examples, train_targets = util.data_generation.generate_data(
    points_number=point_number)  # util.data.generate_toy_data(opt['point_number']) #
test_examples, test_targets = util.data_generation.generate_data(
    points_number=point_number)  # util.data.generate_toy_data(opt['point_number']) #
